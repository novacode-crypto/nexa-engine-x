  ...
  return (
    <div 
      ...
      style={{ 
        ...
        background: '#07071a',
        backgroundImage: `
          radial-gradient(ellipse 200% 120% at 80% -10%, rgba(168,85,247,0.18) 0%, transparent 55%),
          radial-gradient(ellipse 150% 100% at 10% 110%, rgba(6,182,212,0.09) 0%, transparent 55%),
